...
4. Zmień nazwę funkcji definiowanej w tekście source na f i zamień sztywną wartość liczbową na wartość ze zmiennej sec.
   Pamiętaj o usunięciu wcięć po lewej stronie - napis musi spełniać warunki formatowania dla Pythonowych funkcji.
